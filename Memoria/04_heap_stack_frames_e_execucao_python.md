...
### 6.1 ISA (Instruction Set Architecture)

A ISA é o conjunto de instruções que o CPU entende diretamente.

Depois do código Python ser compilado para bytecode, ele é injetado e executado pela PVM. A PVM, por sua vez, vai interpretar o bytecode e comunicar com o Sistema Operativo para realizar as ações necessárias (como alocar memória, ler/escrever ficheiros, etc.).
...
### 6.2 Diagrama sobre todo o processo usando Python
...
## 7. Memória de execução: stack vs heap (versão mais detalhada)

### 7.1 Antes de stack/heap: “onde é que isto existe afinal?”
...
### 7.2 O “mapa” típico de memória de um processo
...
### 7.3 O que é a Stack, em concreto?
...
### 7.4 O que é a Heap, em concreto?
...
### 7.6 Exemplos de tipos de dados e onde vivem
...
### Bloco opcional para colar no Módulo 04: “Para onde vai cada coisa” (Stack/Heap + Referências + Órfãos)
...
#### (Sugestão de secção nova) 7.7 Para onde vai cada coisa: nomes, referências e objetos
